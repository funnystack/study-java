package com.funny.study.java;

import com.funny.study.java.reflection.bean.User;
import com.funny.study.java.reflection.generics.DataInfo;
import com.funny.study.java.reflection.service.UserService;
...
public class MethodReflectionTest {
    ...
    public void testPublicStaticMethod() throws Exception {
        ...
        final Class<?> clazz = Class.forName("com.github.funnystack.sample.reflection.service.UserService");
